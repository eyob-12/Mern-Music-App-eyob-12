...
import {
    ...
    Heading, Input, SimpleGrid, Spinner, Text, useToast,
...
const EditPlaylistPage = () => {
    ...
    const fetchPlaylist = async () => {
        ...
        await axios.get(`http://localhost:4000/playlists/${id}`)
            .then((res) => {
                setInputs({
    ...
    const fetchOtherSongs = async () => {
        ...
        await axios.get("http://localhost:4000/songs/random")
            .then((res) => {
                setOtherSongs((prev) => {
    ...
    const editPlaylist = async () => {
        ...
        await axios.patch(`http://localhost:4000/playlists/${id}`, playlistDetails, {
            headers: {
