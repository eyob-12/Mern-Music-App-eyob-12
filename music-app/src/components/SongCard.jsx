...
const SongCard = ({ song }) => {
    ...
    const handleLike = async () => {
        await axios.patch(`http://localhost:4000/songs/like/${song?._id}`, null, {
            headers: {
...
SongCard.propTypes = {
    song: PropTypes.shape({
        ...
        artistes: PropTypes.arrayOf(PropTypes.string).isRequired,
        // Add any other properties of song here
    }).isRequired,
};
